...
for case in mask_path:
    ...
    if os.path.exists(img_path):
        ...
        name = "/home/yeep/Desktop/graduate/research/annotation/code/InterSeg-main/data/processed_brats18/" + item
        ...
        sitk.WriteImage(cropped_img_itk, name + "_img.nii")
        sitk.WriteImage(cropped_lab_itk, name + "_lab.nii")
